...
public class NegativeTests extends BaseTest {
    ...
    private final String validEmail = "ft.engineer@teo-intl.com";
    ...
    public void addInstrumentWithEmptySerialShowsValidationError() {
        ...
        WebElement saveButton = w.until(ExpectedConditions.elementToBeClickable(By.id("btn-submit-instrument-form")));
        saveButton.click();
        ...
        // Or save button should remain disabled if form invalid
        boolean disabled = false;
        try {
            disabled = !driver.findElement(By.id("btn-submit-instrument-form")).isEnabled();
    ...
    public void addInstrumentWithInvalidSerialShowsValidationError() {
        ...
        Assert.assertTrue(errorShown, "Expected validation error for invalid serial.");
    }
    ...
    public void addUserWithInvalidEmailShowsValidationError() throws InterruptedException {
        ...
        WebElement sendButton = w.until(ExpectedConditions.elementToBeClickable(By.id("btn-submit-user-form")));
        ...
        Assert.assertTrue(errorShown, "Expected validation error for invalid email.");
    }
    ...
    public void addDistributorMissingNameShowsValidationError() throws InterruptedException {
        ...
        WebElement saveButton = w.until(ExpectedConditions.elementToBeClickable(By.id("btn-submit-distributor-form")));
        ...
        Assert.assertTrue(errorShown, "Expected validation error for missing distributor name.");
    }
    ...
    public void addDistributorWithInvalidEmailsShowsValidationError() throws InterruptedException {
        ...
        Assert.assertTrue(errorShown, "Expected validation error for invalid emails.");
    }
